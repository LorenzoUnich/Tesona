...
#            self.fluxexpr="10*0.5*0.5*1e-4*x**-2"
        ...
        print(options.B)
        band =  options.B
        functions_sigmoid  = ['(93.34446907532332+x)/(1+exp(2.660452255180891*x-6.999999290909457)) + (394.9487337400987/(0.6398306223834892*sqrt(2*pi)))*exp(-pow((x-3.471539726708467)/0.6398306223834892,2)/2)',
							  '(84.5232943419101+x)/(1+exp(1.901442374723312*x-6.99999999477764)) + (209.9999999592336/(0.5358492201586051*sqrt(2*pi)))*exp(-pow((x-3.539552559551672)/0.5358492201586051,2)/2)',
							  '(46.007713104863726+x)/(1+exp(1.9592611936935997*x-6.999958002696216)) + (208.27389300135758/(0.5648488242921944*sqrt(2*pi)))*exp(-pow((x-3.5800856999053847)/0.5648488242921944,2)/2)',
							  '(21.157315491834506+x)/(1+exp(1.7074160387113217*x-6.91814452892212)) + (201.35812737863176/(0.6067112941056997*sqrt(2*pi)))*exp(-pow((x-3.533225039671027)/0.6067112941056997,2)/2)']
        if band==  "all":
