...
#all neutrino flavoursx
         ...
         addperiod ("ARCA21_track","inputdata/202475_5_53_29_DETECTORESPONSE_ARCA21_133_tmva_tracks_v10.ALL_zen_b40_pre_upm01_antinoise_bdt095.root","inputdata/DS_P133.all_tmva_tracks_v10_pre_upm01_antinoise_bdt095.pickle",get_gauss_expr_string(gauss_params[band]) ,mcfiletypes = allmcfiletypes, det = det_ARCA,syst_acc = 0.3, syst_PSF = 0.5)
         print("band", band, " with background function", get_gauss_expr_string(gauss_params[band]))
        '''
